  ...
  const PHASES = [
    ...
    },
    {
      ...
      items: [
        ...
        { id: '7',  status: 'current', title: { en: 'Robustness',                    es: 'Robustez' },                                body: { en: 'Detector conflict resolution · chokidar incremental scan · trigger normalization wired everywhere · sm job prune',                       es: 'Resolución de conflictos entre detectores · scan incremental con chokidar · normalización de triggers en todos lados · sm job prune' } },
