  ...
  const PHASES = [
    ...
    },
    {
      ...
      items: [
        ...
        { id: '15a', status: 'planned', title: { en: 'Distribution: single package',    es: 'Distribución: paquete único' },             body: { en: '@skill-map/cli with UI bundled · sm + skill-map binary aliases · sm ui sub-command · settings loader + runtime-settings schema · CI wiring of npm run smoke:demo · web/demo/ deploy on every release', es: '@skill-map/cli con UI incluida · alias de binarios sm + skill-map · sub-comando sm ui · loader de settings + schema runtime-settings · wiring en CI de npm run smoke:demo · deploy de web/demo/ en cada release' } },
