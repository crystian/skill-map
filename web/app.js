  ...
  const PHASES = [
    ...
    },
    {
      ...
      items: [
        ...
        { id: '6',  status: 'current', title: { en: 'Config + onboarding',           es: 'Config + onboarding' },                    body: { en: '.skill-map/settings(.local).json · .skill-mapignore · sm init · frontmatter strict mode',                                                  es: '.skill-map/settings(.local).json · .skill-mapignore · sm init · modo estricto de frontmatter' } },
