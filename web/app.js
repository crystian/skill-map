...
(() => {
  ...
  const PHASES = [
    ...
    },
    {
      ...
      list: 'steps',
      items: [
        { id: '10', status: 'planned', title: { en: 'Job subsystem + first probabilistic extension', es: 'Subsistema de jobs + primera extensión probabilística' }, body: { en: 'state_jobs with atomic claim · kernel-enforced preamble · sm job submit / run / … · ClaudeCliRunner · skill-summarizer · github-enrichment plugin', es: 'state_jobs con claim atómico · preamble forzado por el kernel · sm job submit / run / … · ClaudeCliRunner · skill-summarizer · plugin github-enrichment' } },
    ...
    },
    {
      ...
      items: [
        ...
        { id: '13', status: 'planned', title: { en: 'More providers',        es: 'Más providers' },          body: { en: 'Codex · Gemini · Copilot · generic provider (frontmatter-driven fallback) · per-host sm-<host>-* skill namespace',                         es: 'Codex · Gemini · Copilot · provider genérico (fallback driven por frontmatter) · namespace sm-<host>-* por host' } },
