...
Bump both READMEs in the same commit (English and Spanish must stay in sync). This is a manual step — CI does not enforce it today; flagged for a future automated drift guard.
