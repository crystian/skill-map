...
●  9    Plugin author UX             plugin runtime · plugin migrations · @skill-map/testkit on npm · author guide + reference plugin
  ────────────────────────────────────────────────────────────────────────
   ▶ YOU ARE HERE (2026-05-02) — Phase A complete · Step 14.2 closed (BFF read-side endpoints: /api/{scan,nodes,nodes/:pathB64,links,issues,graph,config,plugins} + envelope schema) · in flight: Step 14.3 (UI vertical slice + DataSourcePort + demo build pipeline)
  ────────────────────────────────────────────────────────────────────────
